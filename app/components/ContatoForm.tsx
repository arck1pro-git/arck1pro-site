...
export default function ContatoForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // investe e valor são obrigatórios no webhook (string). Quando o formulário
    // não coleta esses campos, seguem vazios.
    ...
    try {
      ...
      // Não bloqueia a confirmação por falha de rede/CORS: o webhook recebe a
      // chamada mesmo com a resposta opaca.
    }
